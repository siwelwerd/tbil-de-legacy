...
\begin{activity}{15}
Suppose we have found  \(y(t)\) is a solution of \(\L(y)=0\), we will use \term{variation of parameters} and suppose a solution of \(\L(y_p)=e^{2t}\) is of the form \[y_p =v(t) y(t).\]  
\vfill
